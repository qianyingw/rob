...
y_train = split_df.loc[(split_df['split']=='train') | (split_df['split']=='val'), 'label_blind']

X_test = split_df.loc[split_df['split']=='test', 'text']
y_test = split_df.loc[split_df['split']=='test', 'label_blind']
...
if __name__ == "__main__":
    ...
    parameters = {  'vect__min_df': (4,),
                    'vect__ngram_range': ((1,1),), #((1,1), (1,2)),   
                    'vect__max_features': (7000,), #(1000,2000,3000,4000,5000,6000,7000,8000,9000,10000),
