# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 12:15:07 2019
...
os.chdir(path+'codes/rnn_20190626')
...
import data_process
from data_process import df, split_df, args

os.chdir(path+'codes/rnn_20190626')
import vectorizer
from vectorizer import Vocabulary, SequenceVocabulary, PapersVectorizer, PapersDataset
import model
...
#%% ==================================== Main ====================================            
###### Using embeddings ######
med_w2v = KeyedVectors.load_word2vec_format(path+'wordvec/wikipedia-pubmed-and-PMC-w2v.bin', binary=True)
...
#dataset, vectorizer = PapersDataset.load_dataset_and_load_vectorizer(df=split_df, vectorizer_filepath=args.vectorizer_file)
