...
y_train = split_df.loc[(split_df['split']=='train') | (split_df['split']=='val'), 'label_ssz']

X_test = split_df.loc[split_df['split']=='test', 'text']
y_test = split_df.loc[split_df['split']=='test', 'label_ssz']
...
if __name__ == "__main__":
    ...
    parameters = {  'vect__min_df': (2,4,8,16,32,64),
                    ...
                    'vect__max_features': (1000,2000,3000,4000,5000,6000,7000,8000,9000,10000), #(1000,2000,3000,4000,5000,6000,7000,8000,9000,10000),
