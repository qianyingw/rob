...
#df.loc[df.label_random==1, 'label'] = 'blinded'
#df.loc[df.label_random==0, 'label'] = 'non-blinded'
#df.loc[df.label_random==1, 'label'] = 'ssz'
#df.loc[df.label_random==0, 'label'] = 'non-ssz'
